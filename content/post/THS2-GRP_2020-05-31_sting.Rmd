...
author: Himawork
date: '2020-05-31'
slug: THS2-GRP_2020-05-31_sting
categories:
  - HTML
tags:
  - Reports
...
ProRes = bandProfit('000016', bandRes = bandTest, Proless = 300)
...
SpyKplot('000016', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('600114', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('600114', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('603507', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('603507', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('600460', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('600460', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('600136', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('600136', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('002971', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('002971', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('300797', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('300797', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('000603', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('000603', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('300467', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('300467', bandRes = bandTest, viewNum = 60)
...
ProRes = bandProfit('603727', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('603727', bandRes = bandTest, viewNum = 60)
