...
bandTest = bandSword('600410', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('600410', bandRes = bandTest, Proless = 300)
...
SpyKplot('600410', bandRes = bandTest, viewNum = 60)
...
```{r, echo=FALSE, warning=FALSE}
bandTest = bandSword('002552', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('002552', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('002552', bandRes = bandTest, viewNum = 60)
...
```{r, echo=FALSE, warning=FALSE}
bandTest = bandSword('300046', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300046', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('300046', bandRes = bandTest, viewNum = 60)
